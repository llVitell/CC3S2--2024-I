...
class GameTest {
    ...
    void testPlaceTower_ValidPosition() {
        ...
        mockGame = new Game(mockMap,mockPlayer);
    ...
    void testStartWave_WithEnemies() {
        Game game = new Game(mockMap,mockPlayer);
    ...
    @Test
    void testTowerDefenseGameDependenciesShouldWork(){
        mockGame = new Game(mockMap,mockPlayer);
    }
    @Test
    void testShowMapShouldShowAMap(){
        mockMap = new Map();
        mockMap.showMap();  
    }
}
